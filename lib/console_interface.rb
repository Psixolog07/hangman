class ConsoleInterface
  ...
  def print_out
    ...
    if @game.won?
      puts "Поздравляем, вы выиграли!".colorize(color: :green)
    elsif @game.lost?
      puts "Вы проиграли, загаданное слово: #{@game.word}".colorize(color: :light_red)
    end
  end
  ...
  def word_to_show
    result = @game.letters_to_guess.map { |letter| letter || "__" }
    result.join(" ")   
  end
